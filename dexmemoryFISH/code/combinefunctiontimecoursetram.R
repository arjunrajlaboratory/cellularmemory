...
inputdirectories <- c("/Users/jessi/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/dexmemfish/rep5/all",
                      "/Users/jessi/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/dexmemfish/rep6/all",
                      "/Users/jessi/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/dexmemfish/rep7/all" #here fkbp5 is cy5 and tgm2 is a594
)

outputdirectory <- "//Users/jessi/RajLab Dropbox/Jess Li/Shared_JessL/paper/plots/dexmemfish-altControls/dextimecoursetram"
...
# Function to extract numeric identifier before the underscore
...
# Iterate over each input directory and append data *** changing rep 7 labels to preserve color scheme"
...
ggsave(filename = paste0(outputdirectory, "/combineplottimecoursetram.pdf"), plot = plot, width = 12, height = 8, device = "pdf")
