...
```{r}
nosplit <- read.table("/Users/jess/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/incucyte/colonysplitcontrol/nosplit_3dpre.csv", sep = ",", header = TRUE)
postsplit <- read.table("/Users/jess/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/incucyte/colonysplitcontrol/postsplit.csv", sep = ",", header = TRUE)
postsplitsparse <- read.table("/Users/jess/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/incucyte/colonysplitcontrol/postsplit_b.csv", sep = ",", header = TRUE)
