...
#a <- a %>% dplyr::select(UMI, BC40StarcodeD8, SampleNum) %>% group_by(BC40StarcodeD8) %>% summarise(UMI = sum(UMI))
#b <- b %>% dplyr::select(UMI, BC40StarcodeD8, SampleNum) %>% group_by(BC40StarcodeD8) %>% summarise(UMI = sum(UMI))
#c <- c %>% dplyr::select(UMI, BC40StarcodeD8, SampleNum) %>% group_by(BC40StarcodeD8) %>% summarise(UMI = sum(UMI))
#d <- d %>% dplyr::select(UMI, BC40StarcodeD8, SampleNum) %>% group_by(BC40StarcodeD8) %>% summarise(UMI = sum(UMI))
#e <- e %>% dplyr::select(UMI, BC40StarcodeD8, SampleNum) %>% group_by(BC40StarcodeD8) %>% summarise(UMI = sum(UMI))
