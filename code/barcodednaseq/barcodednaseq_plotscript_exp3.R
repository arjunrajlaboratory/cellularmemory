...
input_directory <- "/Users/jessi/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/barcodednaseq/20230726/exp3/output"
output_directory <- "/Users/jessi/RajLab Dropbox/Jess Li/Shared_JessL/paper/plots/barcodednaseq/20230726/exp3"
...
#hi
a <- dplyr::filter(shavedStarcode, SampleNum == "JL_AT_9")
#lo
b <- dplyr::filter(shavedStarcode, SampleNum == "JL_AT_10")
#hi
c <- dplyr::filter(shavedStarcode, SampleNum == "JL_AT_11")
#lo->hi
d <- dplyr::filter(shavedStarcode, SampleNum == "JL_AT_12")
