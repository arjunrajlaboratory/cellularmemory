...
```{r, warning=FALSE}
datac2 <- read.csv("/Users/jess/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/ap1reporter/starendscatter/cc10/VID2925_C2_recalc.csv")
...
```{r}
data2 <- read.csv("/Users/jess/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/ap1reporter/starendscatter/cc10/VID2925_a2_recalc.csv")

startenddataa2 <- data2
...
```{r}
datab2 <- read.csv("/Users/jess/RajLab Dropbox/Jess Li/Shared_JessL/paper/extractedData/ap1reporter/starendscatter/cc10/VID2925_b2_recalc.csv")
